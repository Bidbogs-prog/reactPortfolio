...
Blastr didn't start life as Blastr. It started with [SoulForge](https://soulforge.proxysoul.com/introduction), a code-intelligence engine built by proxysoul.
...
And credit where it belongs: the graph intelligence underneath Blastr is [SoulForge](https://soulforge.proxysoul.com/introduction), by proxysoul. Blastr stands on that work.
